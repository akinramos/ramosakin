...
function x(){
$.ajax({
	url: "http://www.omdbapi.com/?t=Thor:The Dark World"
}).done(function(res){
	console.log(res);
	let html = `<center>
		...
		<h4>OFFICIALMOVIE TRAILER</h4> 
		<center>	
		<iframe width="500" height="315" src="https://www.youtube.com/embed/npvJ9FTgZbM" frameborder="0" allowfullscreen></iframe>
		</left>
		</div>
		<div id="left">
